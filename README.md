...
Ensure PostgreSQL is running and create the database: CREATE DATABASE raya_ecommerce;
...
5. Run the Servers
Start Backend (Port 8000): uvicorn app.main:app --reload --host 127.0.0.1 --port 8000
